...
namespace NBA_Regular_Season_24_25
{
    public partial class PlayersForm : Form
    {
        ...
        public PlayersForm(string player, string country, string age) : this()
        {
        ...
        public bool ValidateInput()
        {
            ...
            if (Players.IsPlayerExists(Player))
            {
                MessageBox.Show("Игрок с таким именем и фамилией уже существует!");
                return false;
            }
